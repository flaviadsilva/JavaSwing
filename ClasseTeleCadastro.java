...
public class ClasseTeleCadastro extends javax.swing.JFrame {

    public ClasseTeleCadastro() {
        initComponents();
    }
    ...
    private void txtSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtSalvarActionPerformed
        Usuario U1 = new Usuario(txtNome.getText(), txtEmail.getText(), txtCelular.getText());
        System.out.println(U1.toString());
        txtArea.setText(U1.toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClasseTeleCadastro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClasseTeleCadastro().setVisible(true);
            }
        });
    }
